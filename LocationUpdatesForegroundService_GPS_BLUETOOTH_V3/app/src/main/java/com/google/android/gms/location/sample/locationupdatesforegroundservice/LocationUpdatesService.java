...
public class LocationUpdatesService extends Service {
    ...
    private Notification getNotification(boolean isStopped) {
        ...
        if(isStopped){
            text = "Location updates stopped";
        }else{
            text = "Location updates started";
            //text = Utils.getLocationText(mLocation);
        }
    ...
    private void onNewLocation(Location location) {
        ...
        writeToLog(Utils.getLocationLog(location));
        Log.d(TAG,"GPS : " + Utils.getLocationLog(location));
        //Log.d(TAG,"GPS : " + DateFormat.getDateTimeInstance().format(new Date()));
    }
